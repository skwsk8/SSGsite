...
if(jQuery.browser.mobile) { 
    //$("#videoIntro").hide();
	$("#videoIntro").children('source').attr("src", "assets/video/BreakStuffVrWebLoopMobile.mp4");
}
else // Code here will run if the user is navigating the web in a PC
{
    ...
    //$("#videoContainer").removeClass("mobile-background");
	$("#videoIntro").children('source').attr("src", "assets/video/BreakStuffVrWebLoop.mp4");
}
$("#videoIntro")[0].load();
centerBgVideo();
